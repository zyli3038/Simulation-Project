...
def Sim_Value(numPaths, rho, S_0, V_0, Tmax, kappa, theta, sigma, r, q, MaturityList,
                       ExercList):
    ...
    S, V, Vcount0 = Sim_Price(numPaths, rho, S_0, V_0, Tmax, kappa, theta, sigma, r, q)
    for i in range(len(MaturityList)):
        ...
        for j in range(len(ExercList)):
            KK = ExercList[j]
            # Payoff vectors: call options for example
...
Sim_Value(numPaths, rho, S_0, V_0, Tmax,  kappa,theta , sigma, r, q, MaturityList, ExercList)
